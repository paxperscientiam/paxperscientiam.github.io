...
var queryHash = parseQueryString(queryString);
var DEFAULT_URL = 'e_Gov_Survey_2010-optimized.pdf';

if (queryHash.file) {
    DEFAULT_URL = queryHash.file;
}
...
var PDFViewerApplication = {
    ...
    zoomReset: function pdfViewZoomReset(ticks) {
